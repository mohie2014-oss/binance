    ...
    with st.spinner("جاري جلب البيانات الفنية اللحظية بأمان..."):
        try:
            ...
            if response.status_code == 200:
                ...
                if isinstance(page_data_1, list): 
                    all_fetched_coins.extend(page_data_1)
            ...
            if response_2.status_code == 200:
                ...
                if isinstance(page_data_2, list): 
                    all_fetched_coins.extend(page_data_2)
            ...
            if not df.empty:
                ...
                st.warning("⚠️ جدول البيانات فارغ حالياً، اضغط على زر المسح مرة أخرى وسيعمل فوراً.")
